            ...
            <div className="container" ref={contentRef}>
                ...
                <div className="section section__supplier">
                    ...
                    <div className="supplier-code">
                        <div className="supplier-code--title">
                            Supplier Code
                        </div>
                ...
                <div className="section section__bottom-info">
                    ...
                    <div className="payment-terms">
                        <div className="payment-terms--title">
                            Payment Terms
                        </div>
                    ...
                    <div className="other-remarks">
                        <div className="other-remarks--title">
                            Other Remarks
                        </div>
                    ...
                    <div className="conditions">
                        ...
                        <div className="conditions-list">
                            <ul>
                                <li>
                                    <p>
                                        Please issue Delivery Note / Invoice to
                                ...
                                <li>
                                    <p>
                                        ...
                                        between 7:30 - 10:45 &amp; 11:30 - 15:00
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        All deliveries are to be consigned to
